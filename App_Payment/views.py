...
def payment(request):
    ...
    store_id = 'patha65c84eca1bc22'
    API_key = 'patha65c84eca1bc22@ssl'
    # mypayment = s(sandbox=True, store_id='store_id', store_pass='API_key' )
    ...
    print(response_data)
    # return render(request,'App_Payment/payment.html',content_type={})
